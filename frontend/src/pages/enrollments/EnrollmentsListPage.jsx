          ...
          <div className="p-4">
            <CRMTable
              ...
              columns={[
                ...
                { key: 'phone', header: 'Phone Number', width: '120px', className: 'flex items-center', render: (row) => <span className="whitespace-nowrap font-semibold text-slate-700">{row.phone || '-'}</span> },
