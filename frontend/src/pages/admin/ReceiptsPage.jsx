  ...
  return (
    <div className="space-y-6">
      ...
      <section className="grid gap-6 xl:grid-cols-[420px_minmax(0,1fr)]">
        <form onSubmit={createReceipt} className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-[0_18px_45px_-30px_rgba(15,23,42,0.35)]">
                ...
                <tbody className="divide-y divide-slate-200">
                  {receipts.map((receipt) => (
                    <tr key={receipt.id}>
                      ...
                      <td className="px-5 py-4 text-slate-700">{receipt.purpose}</td>
                      <td className="px-5 py-4 font-bold text-slate-950">Rs {formatAmount(receipt.amount)}</td>
                      <td className="px-5 py-4">
                      ...
                      <td className="px-5 py-4">
                        <div className="flex flex-wrap gap-2">
                          <button
                            ...
                            className="rounded-2xl border border-slate-200 px-4 py-2 text-xs font-semibold text-slate-900 transition hover:bg-slate-50 disabled:opacity-60"
                          >
                            View PDF
                          </button>
                          <button
                            ...
                            disabled={activeReceiptId === receipt.id}
                            className="rounded-2xl bg-slate-950 px-4 py-2 text-xs font-semibold text-white transition hover:bg-slate-800 disabled:opacity-60"
                          >
                            Download PDF
                          </button>
                        </div>
