      ...
      <section className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-[0_18px_45px_-30px_rgba(15,23,42,0.35)] sm:p-8">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="flex flex-col gap-3 sm:flex-row lg:flex-col xl:flex-row">
            ...
            <button
              type="button"
              onClick={() => downloadBill(latestBill)}
              disabled={!latestBill || billActionId === latestBill?.id}
              className="inline-flex min-w-[140px] justify-center whitespace-nowrap rounded-2xl border border-slate-200 px-5 py-3 text-sm font-semibold text-slate-900 transition hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-50"
            >
