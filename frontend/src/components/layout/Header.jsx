        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            >
              ...
              <span className="pointer-events-none absolute right-0 top-full mt-2 hidden rounded-lg bg-slate-950 px-2 py-1 text-xs font-semibold text-white shadow-lg group-hover:block">
                Notifications
              </span>
              {unreadCount > 0 && (
              ...
              <div className="absolute right-0 mt-3 w-80 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl">
                ...
                <div className="max-h-96 overflow-auto p-3">
                  {notifications.length === 0 ? (
                    ...
                    <a key={item.id} href={item.related_url || '#'} className={`mb-2 block rounded-xl border px-3 py-2 text-sm ${toneClass(item.type)}`}>
